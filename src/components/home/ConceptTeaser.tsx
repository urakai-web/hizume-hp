        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="fade-in-up">
            ...
            <div className="space-y-5 text-gray-600 leading-relaxed text-sm">
              <p>
                樋爪住宅研究所は、石川県金沢市を拠点に、対話を重ねながら家をつくる建築設計事務所です。ひとりひとり、ひと家族ひと家族の小さな「違い」を見つけ出すことから、家づくりは始まります。
              </p>
              <p>
                一軒の家が完成するまでに、打ち合わせの回数はおよそ40回。既製のプランはありません。土地の声を聴き、そこに暮らす方の想いを丁寧にかたちにしていきます。
              </p>
            </div>
